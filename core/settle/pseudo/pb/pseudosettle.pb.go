...
func init() {
	proto.RegisterType((*Payment)(nil), "pseudo.Payment")
	proto.RegisterType((*PaymentAck)(nil), "pseudo.PaymentAck")
}

func init() { proto.RegisterFile("pseudo.proto", fileDescriptor_3ff21bb6c9cf5e84) }
