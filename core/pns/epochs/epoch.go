// Package epochs implements time-based pns using epochs as index
...
func next(e pns.Index, last int64, at uint64) pns.Index {
	if e == nil {
...
// Next implements pns.Index advancement
func (e *epoch) Next(last int64, at uint64) pns.Index {
