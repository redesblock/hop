...
var _ pns.Lookup = (*finder)(nil)
var _ pns.Lookup = (*asyncFinder)(nil)
...
func (f *finder) At(ctx context.Context, at, after int64) (swarm.Chunk, pns.Index, pns.Index, error) {
...
func (f *asyncFinder) At(ctx context.Context, at, after int64) (swarm.Chunk, pns.Index, pns.Index, error) {
