...
func (*mockListener) Listen(from uint64, updater voucher.EventUpdater, _ *voucher.ChainSnapshot) <-chan struct{} {
	return nil
}
...
func (m *mockBatchListener) HandleCreate(b *voucher.Batch) error {
	m.createCount++
	return nil
}
