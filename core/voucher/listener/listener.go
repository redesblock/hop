...
var (
	...
	ErrPostageSyncingStalled = errors.New("voucher syncing stalled")
)
...
func (l *listener) Listen(from uint64, updater voucher.EventUpdater, initState *voucher.ChainSnapshot) <-chan struct{} {
