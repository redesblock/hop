...
func TestSetWelcomeMessage(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantFail: true,
			message: `zZZbzbzbzbBzBBZbBbZbbbHopzZBZBhopBBBbBzHopZbbBzBBzBBbZz
			
			bBbbZZbzZzbbBbzZbZZZZhopZZbBzZZbZzZzzBzbZZ`, // 513 characters
